...
CREATE TABLE `branchgetfrom` (
  ...
  KEY `branchgetfrom_ibfk_5` (`destinationBranchID`),
  KEY `branchgetfrom_ibfk_4` (`storageID`),
  CONSTRAINT `branchgetfrom_ibfk_1` FOREIGN KEY (`employeeID`) REFERENCES `employee` (`employeeID`) ON DELETE CASCADE,
  CONSTRAINT `branchgetfrom_ibfk_3` FOREIGN KEY (`productCode`) REFERENCES `product` (`productCode`) ON DELETE CASCADE,
  CONSTRAINT `branchgetfrom_ibfk_4` FOREIGN KEY (`storageID`) REFERENCES `branch` (`branchID`) ON DELETE CASCADE,
  CONSTRAINT `branchgetfrom_ibfk_5` FOREIGN KEY (`destinationBranchID`) REFERENCES `branch` (`branchID`) ON DELETE CASCADE
